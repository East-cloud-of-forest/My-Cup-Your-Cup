...
import "../hoyeon test/JoinPage.css"

import Web from "../img/내돈내잔 로고 이미지.jpg"
...
<div className="main-signup">
    ...
    <header>
        <div>
            <Link to="" title="로고 이미지"><img className src={Web} /></Link>
        </div>
    </header>
    ...
    <span className="birthOption">
        ...
        <span className="signup-input-birth">
                        <input className="signup-birth-yy" type="text" placeholder="년(4자)"></input>
                    </span>
                    ...
                    <span className="signup-input-birth">
                        <input className="signup-birth-dd" type="text" placeholder="일"></input>
                    </span>
    </span>
...
<span className="choice">
    ...
    <span className="signup-input">
            <input className="signup-email" type="text" placeholder="선택입력"></input>
</span>
