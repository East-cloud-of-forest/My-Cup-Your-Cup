export default [
  {
    name: 'personal',
    title: '내잔네잔 서비스 이용약관',
    content: `<b>내잔네잔 서비스 이용약관 및 개인정보처리방침</b><br />
    <br />
    < 내잔네잔 >('https://www.mycup-yourcup.com'이하 '내잔네잔')은(는) 「개인정보 보호법」 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리방침을 수립·공개합니다.<br />
    <br />
    ○ 이 개인정보처리방침은 2022년 5월 26부터 적용됩니다.<br />
    <br />
    <br />
    <br />
    제1조(개인정보의 처리 목적)<br />
    <br />
    < 내잔네잔 >('https://www.mycup-yourcup.com'이하 '내잔네잔')은(는) 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며 이용 목적이 변경되는 경우에는 「개인정보 보호법」 제18조에 따라 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다.<br />
    <br />
    1. 홈페이지 회원가입 및 관리<br />
    <br />
    회원 가입의사 확인, 서비스 부정이용 방지 목적으로 개인정보를 처리합니다.<br />
    <br />
    2. 민원사무 처리<br />
    <br />
    ...
    3. 재화 또는 서비스 제공<br />
    <br />
    물품배송, 서비스 제공, 요금결제·정산을 목적으로 개인정보를 처리합니다.<br />
    <br />
    4. 마케팅 및 광고에의 활용<br />
    <br />
    ...
    5. 개인영상정보<br />
    <br />
    교통정보의 수집·분석 및 제공 등을 목적으로 개인정보를 처리합니다.<br />
    <br />
    <br />
    <br />
    제2조(개인정보의 처리 및 보유 기간)<br />
    <br />
    ① < 내잔네잔 >은(는) 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터 개인정보를 수집 시에 동의받은 개인정보 보유·이용기간 내에서 개인정보를 처리·보유합니다.<br />
    <br />
    ② 각각의 개인정보 처리 및 보유 기간은 다음과 같습니다.<br />
    <br />
    1.<홈페이지 회원가입 및 관리><br />
    <홈페이지 회원가입 및 관리>와 관련한 개인정보는 수집.이용에 관한 동의일로부터<홈페이지 탈퇴 시까지>까지 위 이용목적을 위하여 보유.이용됩니다.<br />
    ...
    <br />
    ① < 내잔네잔 >은(는) 다음의 개인정보 항목을 처리하고 있습니다.<br />
    <br />
    1< 홈페이지 회원가입 및 관리 ><br />
    ...
    <br />
    ① < 내잔네잔 > 은(는) 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가 불필요하게 되었을 때에는 지체없이 해당 개인정보를 파기합니다.<br />
    <br />
    ...
    <br />
    1. 파기절차<br />
    < 내잔네잔 > 은(는) 파기 사유가 발생한 개인정보를 선정하고, < 내잔네잔 > 의 개인정보 보호책임자의 승인을 받아 개인정보를 파기합니다.<br />
    ...
    <br />
    ① 정보주체는 내잔네잔에 대해 언제든지 개인정보 열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.<br />
    <br />
    ② 제1항에 따른 권리 행사는내잔네잔에 대해 「개인정보 보호법」 시행령 제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며 내잔네잔은(는) 이에 대해 지체 없이 조치하겠습니다.<br />
    <br />
    ...
    <br />
    ⑥ 내잔네잔은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구, 처리정지의 요구 시 열람 등 요구를 한 자가 본인이거나 정당한 대리인인지를 확인합니다.<br />
    <br />
    <br />
    <br />
    제6조(개인정보의 안전성 확보조치에 관한 사항)<br />
    <br />
    < 내잔네잔 >은(는) 개인정보의 안전성 확보를 위해 다음과 같은 조치를 취하고 있습니다.<br />
    <br />
    ...
    <br />
    ① 내잔네잔 은(는) 이용자에게 개별적인 맞춤서비스를 제공하기 위해 이용정보를 저장하고 수시로 불러오는 ‘쿠키(cookie)’를 사용합니다.<br />
    <br />
    ...
    <br />
    < 내잔네잔 > 은(는) ｢개인정보 보호법｣ 제15조제3항 및 제17조제4항에 따라 ｢개인정보 보호법 시행령｣ 제14조의2에 따른 사항을 고려하여 정보주체의 동의 없이 개인정보를 추가적으로 이용·제공할 수 있습니다.<br />
    이에 따라 < 내잔네잔 > 가(이) 정보주체의 동의 없이 추가적인 이용·제공을 하기 위해서 다음과 같은 사항을 고려하였습니다.<br />
    ...
    <br />
    ① 내잔네잔 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.<br />
    <br />
    ▶ 개인정보 보호책임자<br />
    성명 :김사장<br />
    직책 :사장님<br />
    직급 :사장님<br />
    연락처 :010-1234-5678, mycupyourcup@gmail.com, 010-1234-5678
    ...
    담당자 :사장님<br />
    연락처 :, ,<br />
    ② 정보주체께서는 내잔네잔 의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. 내잔네잔 은(는) 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.<br />
    <br />
    <br />
    <br />
    제11조(국내대리인의 지정)<br />
    <br />
    정보주체는 ｢개인정보 보호법｣ 제39조의11에 따라 지정된 < 내잔네잔 >의 국내대리인에게 개인정보 관련 고충처리 등의 업무를 위하여 연락을 취할 수 있습니다. < 내잔네잔 >은(는) 정보주체의 개인정보 관련 고충처리 등 개인정보 보호책임자의 업무 등을 신속하게 처리할 수 있도록 노력하겠습니다.<br />
    <br />
    ▶ < 내잔네잔 > 은(는) ｢개인정보 보호법｣ 제39조의11에 따라 국내대리인을 지정하였습니다.<br />
    <br />
    ...
    < 내잔네잔 >은(는) 정보주체의 개인정보 열람청구가 신속하게 처리되도록 노력하겠습니다.<br />
    <br />
    ...
    ① < 내잔네잔 >은(는) 아래와 같이 영상정보처리기기를 설치·운영하고 있습니다.<br />
    <br />
    1.영상정보처리기기 설치근거·목적 : < 내잔네잔 >의 시설안전, 화재예방<br />
    <br />
  ...
  <br />
      ...
      3. “몰”에 게시된 정보의 변경<br /><br />
  
      4. “몰”이 정한 정보 이외의 정보(컴퓨터 프로그램 등) 등의 송신 또는 게시<br /><br />
  
      5. “몰” 기타 제3자의 저작권 등 지적재산권에 대한 침해<br /><br />
  
      6. “몰” 기타 제3자의 명예를 손상시키거나 업무를 방해하는 행위<br /><br />
  ...
  {
    name: 'personalshare',
    title: '개인정보 제 3자 제공에 관한 사항',
    content: `<b>개인정보의 제3자 제공에 관한 사항</b><br />
    <br />
    ① < 내잔네잔 >은(는) 개인정보를 제1조(개인정보의 처리 목적)에서 명시한 범위 내에서만 처리하며, 정보주체의 동의, 법률의 특별한 규정 등 「개인정보 보호법」 제17조 및 제18조에 해당하는 경우에만 개인정보를 제3자에게 제공합니다.<br />
    <br />
    ② < 내잔네잔 >은(는) 다음과 같이 개인정보를 제3자에게 제공하고 있습니다.<br />
    <br />
    1. 있을수도 있음<br />
    개인정보를 제공받는 자 : 있을수도 있음<br />
    제공받는 자의 개인정보 이용목적 : 알아서 골라감<br />
    제공받는 자의 보유.이용기간: 그쪽이 알아서 할 듯<br />
    <br />
    <br />
    <br />
    <b>개인정보처리의 위탁에 관한 사항</b><br />
    <br />
    ① < 내잔네잔 >은(는) 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보 처리업무를 위탁하고 있습니다.<br />
    <br />
    1. < 아직 모름 ><br />
    위탁받는 자 (수탁자) : 정해지면 알려드림<br />
    위탁하는 업무의 내용 : 아직 모름<br />
    위탁기간 : 정해지면 알려드림<br />
    ② < 내잔네잔 >은(는) 위탁계약 체결시 「개인정보 보호법」 제26조에 따라 위탁업무 수행목적 외 개인정보 처리금지, 기술적․관리적 보호조치, 재위탁 제한, 수탁자에 대한 관리․감독, 손해배상 등 책임에 관한 사항을 계약서 등 문서에 명시하고, 수탁자가 개인정보를 안전하게 처리하는지를 감독하고 있습니다.<br />
    <br />
