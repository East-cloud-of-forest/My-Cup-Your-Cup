...
import Appsidebar from "./HeaderSidebar/AppSidebar";
...
const Header = () => {
  ...
  return (
    <header id="App_header" className="text-center">
      ...
      >
        <div className="nav_side_bar">
          ...
          <div className="search">
            ...
            <div>
              <ButtonComp icon style={{ width: "45px" }} onClick={onSideSearch}>
      ...
      {/* 카트 사이드바 */}
      <Appsidebar
        offClick={offCartSidebar}
        active={sidebarCartActive}
        activeClass={sidebarCartActiveClass}
        direction={"right"}
        button={
