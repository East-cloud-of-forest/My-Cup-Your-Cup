  ...
  return (
    <footer id="App_footer">
      ...
      <div className="footer_block footer_copyright">
        <p>
          내잔네잔은 통신판매중개자이며 통신판매의 당사자가 아닙니다. 따라서
          내잔네잔은 상품·거래 정보 및 가격에 대하여 책임을 지지 않습니다.{" "}
          <br />
          Copyright My Cup Your Cup All rights reserved.
        </p>
      </div>
      <a href="#" className={classNames("goTop", activeButton && "active")}>
