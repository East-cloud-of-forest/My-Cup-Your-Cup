...
const MyQuastion = (props) => {
    ...
    const addNewPost = () => {
        ...
        const newPost1 = {id:nextId, category: categoryBox, date: dateBox, title: titleBox, body: bodyBox  }
        const newPost2 = [...post]
    ...
    const [ post, setPost ] = useState([
        {id: 1, category:"회원", date:'날짜', title:"게시글 제목", body:"게시글내용 출력"},
        {id: 2, category:"배송", date:'날짜', title:"게시글 제목2", body:"2번째 게시글 내용"},
    ])
    ...
    if(mode==="UPDATE") {
        ...
        updateArea = <UpdatePost update_start={(_title, _body, _category, _date) => {

            const NewPost = [...post]
            const NewObject = { id: id, title: _title, body: _body, category: _category, date: _date}
        ...
        title={title} body={body} category={category} date={date} />
    }
